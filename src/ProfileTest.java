...
class ProfileTest {
    ...
    void setDescriptiontest() {
        Profile testProfile = new Profile("a","generic description", new ArrayList<String>(), new ArrayList<String>());
    ...
    void removeFriendtest() {
        Profile testProfile = new Profile("a", "generic description", new ArrayList<String>(Arrays.asList("b","c","d")), new ArrayList<String>());
    ...
    void removeBlocktest() {
        Profile testProfile = new Profile("a", "generic description", new ArrayList<String>(), new ArrayList<String>(Arrays.asList("b","c","d")));
    ...
    void isFriendtest() {
        Profile testProfile = new Profile("a", "generic description", new ArrayList<String>(Arrays.asList("b","c","d")), new ArrayList<String>());
        Profile testProfile2 = new Profile("b", "generic description", new ArrayList<String>(Arrays.asList("e","f","g")), new ArrayList<String>());
    ...
    void isBlockedtest() {
        Profile testProfile = new Profile("a", "generic description", new ArrayList<String>(), new ArrayList<String>(Arrays.asList("b","c","d")));
        Profile testProfile2 = new Profile("b", "generic description", new ArrayList<String>(), new ArrayList<String>(Arrays.asList("e","f","g")));
